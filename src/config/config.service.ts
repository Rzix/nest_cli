...
import { ConfigFields } from 'src/enum/Config.files.enum';
...
export class ConfigService {
  constructor(@InjectRepository(ConfigEntity) private readonly configRepository:Repository<ConfigEntity>){}
getCurrencyValue(){
